...
int main(int argc, char* argv[]) {
  ...
  for (int i = 0; i < all_files.size(); i++) {
    ...
    cout << "nnum: ";
    for (int d = 0; d < 16; ++d) {
      cout << octree.info().nnum(d) << " ";
    }
    cout << endl << "nnum_cum: ";
    for (int d = 0; d < 16; ++d) {
      cout << octree.info().nnum_cum(d) << " ";
    }
    cout << endl << "nnum_nempty: ";
    for (int d = 0; d < 16; ++d) {
      cout << octree.info().nnum_nempty(d) << " ";
    }
    ...
    cout << endl << "bbox_max_width: " << octree.info().bbox_max_width() << endl;
    cout << "key2xyz: " << octree.info().key2xyz() << endl;
